...
type UpdateUserInfoResp struct {
	...
	ImUserIDs     []string               `protobuf:"bytes,3,rep,name=imUserIDs,proto3" json:"imUserIDs"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateUserInfoResp) GetImUserIDs() []string {
	if x != nil {
		return x.ImUserIDs
	}
	return nil
...
type VerifyCodeReq struct {
	...
	UsedFor           int32                  `protobuf:"varint,5,opt,name=usedFor,proto3" json:"usedFor"`
	DeleteAfterVerify bool                   `protobuf:"varint,6,opt,name=deleteAfterVerify,proto3" json:"deleteAfterVerify"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *VerifyCodeReq) GetUsedFor() int32 {
	if x != nil {
		return x.UsedFor
	}
	return 0
...
func (x *VerifyCodeReq) GetDeleteAfterVerify() bool {
	if x != nil {
...
type ChangePasswordResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ShouldKickOut bool                   `protobuf:"varint,1,opt,name=shouldKickOut,proto3" json:"shouldKickOut"` // 是否踢出
	ImServerID    string                 `protobuf:"bytes,2,opt,name=imServerID,proto3" json:"imServerID"`        // imId
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ChangePasswordResp) GetShouldKickOut() bool {
	if x != nil {
		return x.ShouldKickOut
	}
	return false
}

func (x *ChangePasswordResp) GetImServerID() string {
	if x != nil {
		return x.ImServerID
	}
	return ""
...
type LoginResp struct {
	...
	ImServerIDs   []string               `protobuf:"bytes,4,rep,name=imServerIDs,proto3" json:"imServerIDs"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LoginResp) GetImServerIDs() []string {
	if x != nil {
		return x.ImServerIDs
	}
	return nil
}
...
type GetTokenForVideoMeetingResp struct {
	...
	SdkAppId      int64                  `protobuf:"varint,4,opt,name=sdkAppId,proto3" json:"sdkAppId"`
	UserSig       string                 `protobuf:"bytes,5,opt,name=userSig,proto3" json:"userSig"`
	...
	ExpiresAt     int64                  `protobuf:"varint,8,opt,name=expiresAt,proto3" json:"expiresAt"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetTokenForVideoMeetingResp) GetProvider() string {
	if x != nil {
		return x.Provider
	}
	return ""
...
func (x *GetTokenForVideoMeetingResp) GetSdkAppId() int64 {
	if x != nil {
		return x.SdkAppId
	}
	return 0
...
func (x *GetTokenForVideoMeetingResp) GetUserSig() string {
	if x != nil {
		return x.UserSig
	}
	return ""
...
func (x *GetTokenForVideoMeetingResp) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
func (x *GetTokenForVideoMeetingResp) GetRoomID() string {
	if x != nil {
		return x.RoomID
	}
	return ""
...
func (x *GetTokenForVideoMeetingResp) GetExpiresAt() int64 {
	if x != nil {
		return x.ExpiresAt
	}
	return 0
...
const file_chat_chat_proto_rawDesc = "" +
	...
	"\fRegisterType\x18\x0f \x01(\v2\x1b.openim.protobuf.Int32ValueR\fRegisterType\"h\n" +
	"\x12UpdateUserInfoResp\x12\x18\n" +
	"\afaceUrl\x18\x01 \x01(\tR\afaceUrl\x12\x1a\n" +
	"\bnickName\x18\x02 \x01(\tR\bnickName\x12\x1c\n" +
	"\timUserIDs\x18\x03 \x03(\tR\timUserIDs\"1\n" +
	...
	"\ausedFor\x18\x05 \x01(\x05R\ausedFor\x12,\n" +
	"\x11deleteAfterVerify\x18\x06 \x01(\bR\x11deleteAfterVerify\"\x10\n" +
	...
	"\vnewPassword\x18\x03 \x01(\tR\vnewPassword\"Z\n" +
	"\x12ChangePasswordResp\x12$\n" +
	"\rshouldKickOut\x18\x01 \x01(\bR\rshouldKickOut\x12\x1e\n" +
	"\n" +
	"imServerID\x18\x02 \x01(\tR\n" +
	"imServerID\".\n" +
	...
	"\vimServerIDs\x18\x04 \x03(\tR\vimServerIDs\"\xa2\x01\n" +
	...
	"\bidentity\x18\x02 \x01(\tR\bidentity\"\xf1\x01\n" +
	...
	"\bsdkAppId\x18\x04 \x01(\x03R\bsdkAppId\x12\x18\n" +
	"\auserSig\x18\x05 \x01(\tR\auserSig\x12\x16\n" +
	"\x06userID\x18\x06 \x01(\tR\x06userID\x12\x16\n" +
	"\x06roomID\x18\a \x01(\tR\x06roomID\x12\x1c\n" +
	"\texpiresAt\x18\b \x01(\x03R\texpiresAt\"F\n" +
