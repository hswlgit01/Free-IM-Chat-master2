...
type UserFullInfo struct {
	...
	UserChatID       string                 `protobuf:"bytes,1,opt,name=userChatID,proto3" json:"userChatID"`
	...
	OrgRole          string                 `protobuf:"bytes,18,opt,name=orgRole,proto3" json:"orgRole"`
...
func (x *UserFullInfo) GetUserChatID() string {
	if x != nil {
		return x.UserChatID
	}
	return ""
...
func (x *UserFullInfo) GetOrgRole() string {
	if x != nil {
		return x.OrgRole
	}
	return ""
...
const file_common_common_proto_rawDesc = "" +
	"\n" +
	"\x13common/common.proto\x12\x12openim.chat.common\"\xa2\x04\n" +
	"\fUserFullInfo\x12\x1e\n" +
	"\n" +
	"userChatID\x18\x01 \x01(\tR\n" +
	"userChatID\x12\x1a\n" +
	...
	"\fregisterType\x18\x10 \x01(\x05R\fregisterType\x12\x16\n" +
	"\x06userID\x18\x11 \x01(\tR\x06userID\x12\x18\n" +
	"\aorgRole\x18\x12 \x01(\tR\aorgRole\"\xbc\x01\n" +
