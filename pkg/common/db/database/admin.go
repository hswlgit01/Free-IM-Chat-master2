...
type AdminDatabaseInterface interface {
	...
	GetSuperAdminForbidden(ctx context.Context, userID string) (*admindb.SuperAdminForbidden, error)
...
func NewAdminDatabase(cli *mongoutil.Client, rdb redis.UniversalClient) (AdminDatabaseInterface, error) {
	...
	superAdminForbidden, err := admin.NewSuperAdminForbidden(cli.GetDB())
	if err != nil {
		return nil, err
	}
	...
	return &AdminDatabase{
		...
		superAdminForbidden: superAdminForbidden,
...
type AdminDatabase struct {
	...
	superAdminForbidden admindb.SuperAdminForbiddenInterface
...
func (o *AdminDatabase) GetSuperAdminForbidden(ctx context.Context, userID string) (*admindb.SuperAdminForbidden, error) {
	return o.superAdminForbidden.Take(ctx, userID)
}
