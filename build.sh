...
# DEP-IM-CHAT 后端服务构建脚本
# DEP-IM-CHAT 后端服务构建脚本
# 使用方法: sh build.sh v1.0.0

# 配置
ORG="freechatim"
REPO="freechat-chat-end"
...
echo "🚀 开始构建 freechat-chat-end 后端镜像..."
echo "📦 镜像名称: $FULL_NAME"
echo ""
...
echo "🚀 运行命令: docker run -p 10001:10001 -p 10002:10002 --name freechat-chat $FULL_NAME"
echo "🔧 带配置运行: docker run -p 10001:10001 -p 10002:10002 -v ./config:/im-chat/config --name freechat-chat $FULL_NAME"