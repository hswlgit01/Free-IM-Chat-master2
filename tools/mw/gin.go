...
func CorsHandler() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.Header(
			...
			"Content-Length, Access-Control-Allow-Origin, Access-Control-Allow-Headers,Cache-Control,Content-Language,Content-RewardType,Expires,Last-Modified,Pragma,FooBar",
